...
def launch_browser(url: str = "https://www.google.com") -> str:
    """
    Launches a browser window and navigates to the specified URL.
    The browser will remain open until the user manually closes it or the script is terminated.
    """
