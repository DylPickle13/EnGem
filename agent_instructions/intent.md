...
- As well if the user requires the need to access files, or run code, or use tools, or search google, or use the browser, or generate images or videos, or conduct deep research or access google drive, respond with <complex> to indicate that a complex workflow should be initiated.
