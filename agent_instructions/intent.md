...
As well if the user requires the need to access files, or run code, or use tools, respond with <complex> to indicate that a complex workflow should be initiated.