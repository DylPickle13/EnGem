...
2. For each sub-task, specify the tool or function that should be used to accomplish it. The available tools are: run_python, run_google_search, git_push, use_browser, and memory functions. Your sub-agents can actually use the browser, do not say they cannot, just give the them instructions on how to use it. 
